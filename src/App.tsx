...
function App() {
  return (
    <>
          ...
          __html: `
            ...
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            #loader video { 
              width: 180px; 
              max-width: 220px; 
              filter: none; /* ← Video original sin filtro negro */
            ...
            /* Hover con brinquito (solo en PC) */
            .symbol:hover {
      ...
      <audio id="hum" preload="auto">...</audio>
      <audio id="whoosh" preload="auto">...</audio>
      <audio id="portal-sound" preload="auto">...</audio>
